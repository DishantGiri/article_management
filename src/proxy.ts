...
const ROLE_ROUTES: Record<string, string[]> = {
  SUPER_ADMIN: ["/", "/products", "/articles", "/links", "/sites", "/categories", "/product-categories", "/reports", "/history", "/users", "/notifications", "/notices", "/settings", "/team-members", "/calendar", "/commission-settings", "/commissions", "/commission-list", "/user-commissions"],
  ADMIN: ["/", "/products", "/articles", "/links", "/sites", "/categories", "/product-categories", "/reports", "/history", "/users", "/notifications", "/notices", "/settings", "/team-members", "/calendar", "/user-commissions"],
  TEAM_LEAD: ["/", "/products", "/articles", "/links", "/reports", "/notifications", "/notices", "/settings", "/team-members", "/calendar", "/user-commissions"],
  LINKER: ["/", "/products", "/links", "/sites", "/categories", "/product-categories", "/reports", "/notifications", "/notices", "/settings", "/calendar", "/user-commissions"],
