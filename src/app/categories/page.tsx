      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-[#737373] dark:text-slate-400 text-sm mt-0.5 font-medium">
            Manage product categories that can be assigned across websites and products (Super Admin, Admin & Linker)
          </p>
        </div>
        {canManage && (
          <button
      ...
      {loading ? (
        <div className="py-16">
          <LoadingScreen
            ...
            subtext="Retrieving category classifications and site links"
            size="md"
          />
        </div>
      ) : categories.length === 0 ? (
            ...
            <form onSubmit={handleAddCategory} className="p-5 bg-white dark:bg-slate-900 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Weight Loss, Skincare, Tech, Supplements"
