        ...
        <div className="space-y-6 lg:sticky lg:top-6 lg:max-h-[calc(100vh-3rem)] lg:overflow-y-auto pr-2 pb-6 scrollbar-thin" style={{ scrollbarWidth: 'thin' }}>
          ...
          {(currentUserRole === "TEAM_LEAD" || currentUserRole === "ADMIN" || currentUserRole === "SUPER_ADMIN") && (
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-4">
              <div>
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-bold text-[#4A4A4A]">Review Article</h3>
                ...
                <p className="text-xs text-[#737373] mt-1 font-medium">
                  {article.status === "APPROVED"
                    ? "This article has already been approved. You can still request a redo if revisions are needed."
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-[#CBCBCB] text-sm focus:outline-none focus:ring-2 focus:ring-[#6D8196]/20 focus:border-[#6D8196] bg-white transition"
                  />
                </div>
                ...
                <div>
                        ...
                        className={`flex-1 py-2 rounded-xl text-xs font-bold border transition cursor-pointer ${
                          redoPriority === p
                            ? p === "HIGH"
                              ...
                              : "bg-[#6D8196] text-white border-[#5A6D81]"
                            : "bg-[#FAF9F5] text-[#4A4A4A] border-[#CBCBCB] hover:border-[#6D8196]"
                        }`}
                      >
                  ...
                  <p className="text-[10px] text-[#737373] mt-1.5">Only applied when requesting a redo.</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button
                    ...
                    disabled={submittingReview || article.status === "APPROVED"}
                    className={`py-2.5 px-4 rounded-xl text-xs font-bold transition flex items-center justify-center gap-1.5 cursor-pointer ${
                      article.status === "APPROVED"
                        ...
                        : "bg-[#6D8196] hover:bg-[#5A6D81] text-white shadow-xs"
                    }`}
                  >
